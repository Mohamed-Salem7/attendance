...
class Course extends StatelessWidget {
  const Course({Key? key, required this.name, required this.courseId, required this.drName, required this.members}) : super(key: key);
      ...
      builder:(context,state){return  Row(
        children: [
          ...
          ElevatedButton(
            onPressed: ()
            {
              MainCubit.get(context).joinToCourse(courseId: courseId, name: name, drName: drName, members: members);
            },
            style: ButtonStyle(
